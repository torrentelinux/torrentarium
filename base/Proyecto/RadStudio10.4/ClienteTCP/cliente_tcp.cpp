...
// Enlaces  : https://github.com/torrentelinux/torrentarium/wiki/TServer:-servidor-de-tiempo
//            https://docwiki.embarcadero.com/CodeExamples/Tokyo/en/Chat_Room_Socket_(C++)
//            https://docwiki.embarcadero.com/CodeExamples/Alexandria/en/Chat_Room_Socket_(C++)
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
// Evento Tecla presionada, control edtComando
void __fastcall TfrmClienteTCP::edtComandoKeyPress(TObject *Sender, System::WideChar &Key)
{
   // Si presiona la tecla Intro, invoca al evento del botón Enviar
   if(Key == 13)
     this->btnEnviarClick(Sender);
}
//---------------------------------------------------------------------------
void __fastcall TfrmClienteTCP::SocketClienteLookup(TObject *Sender, TCustomWinSocket *Socket)
{
   mmSalida->Text = mmSalida->Text + "Iniciando la conexión.";
   mmSalida->Lines->Append("------\r\n");
}
//---------------------------------------------------------------------------
void __fastcall TfrmClienteTCP::SocketClienteConnecting(TObject *Sender, TCustomWinSocket *Socket)
{
   mmSalida->Text = mmSalida->Text + "Conectando al servidor "+ SocketCliente->Address + ":" + SocketCliente->Port +  "\r\n";
   mmSalida->Lines->Append("------\r\n");
...
//---------------------------------------------------------------------------
void __fastcall TfrmClienteTCP::SocketClienteWrite(TObject *Sender, TCustomWinSocket *Socket)
{
   mmSalida->Text = mmSalida->Text + "Datos enviados.";
   mmSalida->Lines->Append("------\r\n");
}
//---------------------------------------------------------------------------

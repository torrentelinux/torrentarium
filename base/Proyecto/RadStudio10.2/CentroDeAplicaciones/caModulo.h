...
__published:	// IDE-managed Components
	...
	void __fastcall lblComprobarMouseEnter(TObject *Sender);
	void __fastcall lblComprobarMouseLeave(TObject *Sender);
	void __fastcall lblComprobarClick(TObject *Sender);
	void __fastcall lblComprobarJDevClick(TObject *Sender);
	void __fastcall lblComprobarJDevMouseEnter(TObject *Sender);
	void __fastcall lblComprobarJDevMouseLeave(TObject *Sender);

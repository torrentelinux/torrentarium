...
REM Versión 6.0 de hay-red.cmd para Windows en español y en inglés.
REM Es más eficaz que las otras versiones.
REM Es compatible con TCC LE x64 (Take Command 14.0).
REM ---------------------------------------------------------------
chcp 1252 > nul
set silencioso=0
if "%1" == "" goto paso1
...
:rutina
echo hay-red.cmd [versión 6.0 * junio\2023]
